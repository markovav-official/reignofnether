...
public class AltarOfDarkness extends ProductionBuilding {
    ...
    public AltarOfDarkness() {
        ...
        this.productions.add(ProductionItems.NECROMANCER, Keybindings.key3);
        this.productions.add(ProductionItems.NECROMANCER_REVIVE, Keybindings.key3);
        this.productions.add(ProductionItems.WRETCHED_WRAITH, Keybindings.key4);
        this.productions.add(ProductionItems.WRETCHED_WRAITH_REVIVE, Keybindings.key4);
    }

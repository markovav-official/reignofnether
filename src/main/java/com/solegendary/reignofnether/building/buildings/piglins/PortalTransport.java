...
public class PortalTransport extends AbstractPortal {
    ...
    public PortalTransport() {
        ...
        this.abilities.add(new ConnectPortal(), Keybindings.key3);
        this.abilities.add(new GotoPortal(), Keybindings.key4);
        this.abilities.add(new DisconnectPortal(), Keybindings.key5);
    }

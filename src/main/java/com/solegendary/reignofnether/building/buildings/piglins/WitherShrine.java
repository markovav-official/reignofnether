...
public class WitherShrine extends ProductionBuilding {
    ...
    public WitherShrine() {
        ...
        this.productions.add(ProductionItems.RESEARCH_WITHER_CLOUDS, Keybindings.key3);
        this.productions.add(ProductionItems.RESEARCH_FIRE_RESISTANCE, Keybindings.key4);
    }

...
public class Library extends ProductionBuilding {
    ...
    public Library() {
        ...
        this.abilities.add(new EnchantMaiming(), Keybindings.key3);
        this.abilities.add(new EnchantQuickCharge(), Keybindings.key4);
        this.abilities.add(new EnchantSharpness(), Keybindings.key5);
